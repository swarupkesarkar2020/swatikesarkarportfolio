  ...
  values: [
    {
      title: 'Clarity',
      body:
        'Breaking complex ideas into simple, memorable steps for children, parents, and professional reviewers.',
    },
    {
      title: 'Patience',
      body:
        'Meeting learners where they are, then guiding them toward steady progress without pressure.',
    },
    {
      title: 'Confidence',
      body:
        'Helping students speak, think, and choose with more independence over time.',
    },
  ],
  highlights: [
